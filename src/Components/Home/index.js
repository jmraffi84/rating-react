                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <ul classNameName="fa-ul">
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span><strong>Unlimited Users</strong>
                                    </li>
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span>150GB Storage</li>
                                    ...
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span>Unlimited Private Projects</li>
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span>Dedicated Phone Support</li>
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span><strong>Unlimited</strong> Free
                                        Subdomains</li>
                                    <li><span classNameName="fa-li"><i classNameName="fas fa-check"></i></span>Monthly Status Reports</li>
                                </ul>
                                <div className="d-grid">
                                    <a href="/" className="btn btn-primary text-uppercase">Button</a>
                                </div>
